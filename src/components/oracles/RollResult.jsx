...
export default function RollResult({ result, diceType, sides, onComplete }) {
  ...
  return (
    <div className="relative w-full py-8 px-4 bg-bg-secondary/30 backdrop-blur-sm border-2 border-accent-cyan/50 overflow-hidden">
      ...
      <div className={cn(
        ...
        <div className="text-center mb-2">
          <span className={cn(
            'text-sm font-orbitron uppercase tracking-wider opacity-70',
            getVariantColor()
          )}>
            {diceType}
          </span>
        ...
        <div className="text-center">
          <span className={cn(
            ...
            'inline-block',
            isRevealing ? 'text-6xl scale-0 opacity-0' : 'text-8xl scale-100 opacity-100 result-reveal',
            getVariantColor(),
            getGlowClass()
          )}>
            {result}
